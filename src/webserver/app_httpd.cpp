...
static esp_err_t move_handler(httpd_req_t *req) {
  ...
  // Extract the speed and turn values X and Y from the string of the form
  // /move?X,Y
  ...
  // Convert the speed and turn values to move params and send them to the
  // wheels
  move_params_t move_params =
      get_move_params_from_joystick_coordinates(speed, turn);
...
void startCameraServer() {
  ...
  httpd_uri_t move_uri = {.uri = "/move",
                          .method = HTTP_GET,
                          .handler = move_handler,
                          .user_ctx = NULL};

  httpd_uri_t ledon_uri = {.uri = "/ledon",
                           .method = HTTP_GET,
                           .handler = ledon_handler,
                           .user_ctx = NULL};

  httpd_uri_t ledoff_uri = {.uri = "/ledoff",
                            .method = HTTP_GET,
                            .handler = ledoff_handler,
                            .user_ctx = NULL};

  httpd_uri_t spinleft_uri = {.uri = "/spinleft",
                              .method = HTTP_GET,
                              .handler = spinleft_handler,
                              .user_ctx = NULL};

  httpd_uri_t spinright_uri = {.uri = "/spinright",
                               .method = HTTP_GET,
                               .handler = spinright_handler,
                               .user_ctx = NULL};

  httpd_uri_t stop_uri = {.uri = "/stop",
                          .method = HTTP_GET,
